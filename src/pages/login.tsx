    ...
    <div className="max-w-sm mx-auto px-4 py-12">
      <div className="text-center mb-8">
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Log in to send emergency alerts
        </p>
      </div>
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-2 border border-border bg-card py-3 rounded-xl text-sm font-medium hover:bg-muted transition-all"
      >
